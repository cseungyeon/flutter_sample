...
interface MessageApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: MessageApi?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.flutter_sample.MessageApi.getHostLanguage", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.flutter_sample.MessageApi.sendMessage", codec)
        if (api != null) {
